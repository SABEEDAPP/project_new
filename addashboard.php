...
<body>
  ...
  <header class="main-header clearfix" role="header">
    ...
    <nav id="menu" class="main-nav" role="navigation">
      <ul class="main-menu">
        <li><a href="#section1">Notification</a></li>
        <li class="has-submenu"><a href="#section2">Payment</a>
          <ul class="sub-menu">
            <li><a href="#section2">Offline</a></li>
            <li><a href="#section3">Online</a></li>
            <li><a href="https://templatemo.com/about" rel="sponsored" class="external">External URL</a></li>
          </ul>
        </li>
        <li><a href="#section4">Food Menu</a></li>
        <li class="has-submenu"><a href="#section2">Rooms</a>
          <!-- <ul class="sub-menu">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12">
          <div id='tabs'>
            <ul>
              <li><a href='#tabs-1'>Double-Queen</a></li>
              <li><a href='#tabs-2'>Bed in 6 Bed-Dormitory Room</a></li>
              <li><a href='#tabs-3'>Double Room with Private Bathroom</a></li>
            </ul>
            <section class='tabs-content'>
              <article id='tabs-1'>
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <h4>Double-Queen</h4>
                    <p>Room size: 20 m²/215 ft²<br>Street view<br> 1 queen bed</p>
                  </div>
                </div>
              </article>
              <article id='tabs-2'>
                <div class="row">
                  <div class="col-md-6">
                    <img src="dobroom.jpeg" alt="">
                  </div>
                  <div class="col-md-6">
                    <h4>Bed in 6 Bed-Dormitory Room</h4>
                    <p>Room size: 15 m²/115 ft²<br>Street view<br> 1 single bed</p>
              ...
              <article id='tabs-3'>
                <div class="row">
                  <div class="col-md-6">
                    <img src="doubleroomwprbath.jpg" alt="">
                  </div>
                  <div class="col-md-6">
                    <h4>Double Room with Private Bathroom</h4>
                    <p>Room size: 15 m²/115 ft²<br>Street view<br> 1 double bed</p>
                  </div>
                </div>
              </article>
            </section>
